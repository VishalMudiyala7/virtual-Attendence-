...
ManmohanSingh = face_recognition.load_image_file(r"D:\Digital Image Processing\Lab\PROJECT\venv\STUDENTS\manmohansingh.jpeg")
ManmohanSingh_train = face_recognition.face_encodings(ManmohanSingh)[0]
